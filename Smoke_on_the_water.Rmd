...
```{r, echo=FALSE, fig.cap="Poster presented at the ASLO Aquatic Sciences Meeting in 2025", out.width = '100%', out.height='100%', fig.align='center'}
knitr::include_graphics("figures/ASLO2025_poster.pdf")
```
