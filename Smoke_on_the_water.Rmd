...
<p class="project-text">
 ...
 <p class="project-text">
    You can read the full study <a href="https://aslopubs.onlinelibrary.wiley.com/doi/epdf/10.1002/lno.70087" target="_blank" rel="noopener noreferrer">here</a>, summarized by the poster below.
  </p>
  
```{r, echo=FALSE, fig.cap="", out.width = '150%', fig.align='center'}
knitr::include_graphics("figures/ASLO2025_poster.png")
```
